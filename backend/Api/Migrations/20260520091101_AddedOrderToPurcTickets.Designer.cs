...
namespace Api.Migrations
{
    ...
    [Migration("20260520091101_AddedOrderToPurcTickets")]
    partial class AddedOrderToPurcTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.PurchasedTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("EventDateSnapshot")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("TicketTypeSnapshot")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Api.Models.PurchasedTicket", b =>
                {
                    ...
                    b.HasOne("Api.Models.User", "UsedByStaff")
                        .WithMany()
