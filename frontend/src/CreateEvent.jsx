                                    ...
                                    <div id="staff_event_ticket_tier" className="align_column" key={index}>
                                        ...
                                        <div id="staff_info_card_input_group">
                                            <div id="staff_event_card_input" className="align_column">
                                                ...
                                                <input id={`tier_qty_${index}`} type="text" value={tier.quantity} onChange={e => handleTierChange(index, 'quantity', e.target.value)} className={errors.tiers && errors.tiers[index] && errors.tiers[index].quantity ? "input-error" : ""} />
                                            ...
                                            <div id="staff_event_card_input" className="align_column">
                                                ...
                                                <input id={`tier_price_${index}`} type="text" value={tier.price} onChange={e => handleTierChange(index, 'price', e.target.value)} className={errors.tiers && errors.tiers[index] && errors.tiers[index].price ? "input-error" : ""} />
